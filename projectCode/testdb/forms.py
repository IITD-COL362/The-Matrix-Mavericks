...
class RestForm(forms.Form):
    ...
    avgcost1 = forms.IntegerField(label = 'Lower price limit' ,required = False, widget=forms.Select(choices= lavg))
    avgcost2 = forms.IntegerField(label = 'Upper price limit' ,required = False, widget=forms.Select(choices= havg))
    rating = forms.IntegerField(label = 'Minimum Rating' ,required = False, widget=forms.Select(choices = rating_choices))
    votes = forms.IntegerField(label = 'Minimum Votes' ,required = False, widget=forms.Select(choices= votes_choices))
    ...
    idn = forms.CharField(label= 'Delevering Now' ,required = False, widget=forms.Select(choices = yes_no))
...
class FoodForm(forms.Form):
    ...
    veg = forms.CharField(label= 'Veg/Non-veg' ,required = False, widget=forms.Select(choices = cveg))
    calorie = forms.CharField(label = 'Calorie amount' ,required = False, widget=forms.Select(choices= crange))
    carbohydrate = forms.CharField(label = 'Carbohydarte content' ,required = False, widget=forms.Select(choices= crange))
    protein = forms.CharField(label = 'Protein content' ,required = False, widget=forms.Select(choices = crange))
    fat = forms.CharField(label = 'Fat content' ,required = False, widget=forms.Select(choices= crange))
    sodium = forms.CharField(label = 'Sodium content' ,required = False, widget=forms.Select(choices= crange))
...
class AddRest(forms.Form):
    ...
    avg_cost_for_two = forms.FloatField(label= 'Expected avg cost for two :')
